  ...
  return (
    <Paper sx={{ height: 355 }}>
      ...
      <Stack mt={3} width={1} spacing={3} justifyContent="center">
        <Box px={2.5} py={2} width={1} maxWidth={320} borderRadius={1.75} boxShadow={customShadows[0]}>
      ...
      <BalanceChart data={[20, 30, 50, 45, 60, 20, 40, 50, 30, 60, 40, 50, 20, 45, 30]} sx={{ width: 1, height: '220px !important' }} />
    </Paper>
  );
};
